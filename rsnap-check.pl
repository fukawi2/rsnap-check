#!/usr/bin/perl -w
#
# check_rsnapshot.conf
#
# Nagios plugin to check backups made with rsnapshot
#
# usage: check_rsnapshot.pl /path/to/rsnapshot.conf
#
# Author: Till Elsner, till.elsner@henkel.com
# Version 1.1
#
# Changes:
# > 02/05/2009  Version 1.0
# > 02/19/2009  Version 1.1
# >             Added include_conf support for multiple
# >             configuration files
#

use strict;

my $_VERSION = "check_rsnapshot.pl Version 1.1\n";
